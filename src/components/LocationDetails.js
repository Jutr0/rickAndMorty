  ...
  return (
    <Fragment>
      <div className="container bg-green-600 m-10 p-0 mx-auto flex justify-evenly items-center rounded-3xl flex-col">
        ...
        <div className="text-3xl font-medium text-gray-400 pb-9">
          {dimension} <br />
          {type}
        </div>
      </div>
      <div className="container bg-green-600 m-10 p-0 mx-auto flex justify-evenly items-center rounded-3xl flex-col divide-y-2 divide-dashed">
        ...
        {residents.length ? (
          ...
          <span
            className="p-8 flex mx-3 max-w-full items-center justify-center pb-20 text-6xl font-bold uppercase"
            style={{ borderTop: "none", width: "70%" }}
          >
            Not Found
          </span>
